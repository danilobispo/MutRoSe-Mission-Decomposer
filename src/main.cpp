...
int main(int argc, char** argv) {
	...
	*/
	...
	std::ofstream ofs;
	ofs.open("goal_ordering.txt", std::ofstream::out | std::ofstream::trunc);
	ofs.close();
	print_gm_to_file(gm);
	...
	// Clean file content before writing in function below
	ofs.open("at_instances_info.txt", std::ofstream::out | std::ofstream::trunc);
	ofs.close();
	print_at_instances_info_to_file(at_instances);
	...
	*/
	...
	// Clean file content before writing in function below
	ofs.open("general_annot_orderings.txt", std::ofstream::out | std::ofstream::trunc);
	ofs.close();
	print_general_annot_to_file(gmannot);
